...
USER_NAME = os.environ['USER_NAME'] # e.g., 'AtharvM02222'
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    justify_format(root, 'commit_data', commit_data, 7)
    ...
    justify_format(root, 'loc_add', loc_data[0], 12)
...
if __name__ == '__main__':
    """
    Atharv Mandlavdiya (AtharvM02222), 2025
    Based on Andrew Grant's (Andrew6rant) GitHub Profile README
    """
    ...
    # This section is kept for compatibility but can be removed for new users
